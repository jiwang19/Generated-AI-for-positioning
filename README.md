...
The dataset can be downloaded at - [datafountain](https://www.datafountain.cn/competitions/575/datasets) and - [ieee-dataport](https://ieee-dataport.org/open-access/ultra-denseindoor-mamimo-csi-dataset)
